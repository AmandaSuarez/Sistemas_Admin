    ...
    <div class="app-wrapper">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img
                                src="uploads/fotos/amanda.jpg"
                                class="user-image rounded-circle shadow"
                                alt="User Image" />
                            <span class="d-none d-md-inline">Amanda Suárez</span>
                        </a>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                <!--begin::Brand Link-->
                <a href="./index.html" class="brand-link d-flex align-items-center gap-2 ps-3">
                    <!--begin::Brand Image-->
                    <img
                        src="uploads/img/salon_logo.png"
                        alt="GLAMOUR Logo"
                        class="brand-image" 
                        style="height: 32px; width: auto;" />
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-normal text-white fs-4">GLAMOUR</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
                    ...
                    <ul
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./?view=inventario" class="nav-link">
                                        <i class="nav-icon bi bi-boxes"></i>
                                        <p>Inventario</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./?view=ingreso" class="nav-link">
